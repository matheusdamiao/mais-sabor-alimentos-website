  ...
  return (
    <div className='relative h-[600px] '>
        <div className='flex px-6 flex-col gap-[50px] items-center justify-center max-w-6xl h-[70%] w-full mx-auto'>
            ...
            <a className='bg-[#EFD93F] px-4 z-50 font-semibold text-[#020202] py-3 w-full max-w-[350px] flex items-center justify-center' href=""> Quero ser cliente Mais Sabor</a>
        </div>
